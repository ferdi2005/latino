...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { image: @study.image, title: @study.title, video: @study.video } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { image: @study.image, title: @study.title, video: @study.video } }
